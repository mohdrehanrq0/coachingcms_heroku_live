...
@section('certificate_active', 'cactive')
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $list)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/admin/generate_certificate/' . base64_encode($list->id)) }}">
                                            <button type="button" class="btn btn-success btn-rounded btn-icon" data-toggle="tooltip" title="Generate Certificate">
